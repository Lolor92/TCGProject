...
enum class ETCGEffectStepType : uint8
{
	...
	DetachFilteredMaterials UMETA(DisplayName = "55 - Generic: Detach Filtered Materials"),
	StealMaterials UMETA(DisplayName = "56 - Generic: Steal Materials"),
	DiscardSource UMETA(DisplayName = "57 - Generic: Discard Source"),
	DestroyUnit UMETA(DisplayName = "58 - Generic: Destroy Unit"),
	DestroyUnitsWithMatchingMaterialCount UMETA(DisplayName = "59 - Generic: Destroy Own + Opponent With Same Material Count"),
	ReturnUnitToHand UMETA(DisplayName = "60 - Generic: Return Unit To Hand"),
	ReturnUnitToBottomDeck UMETA(DisplayName = "61 - Generic: Return Unit To Bottom Deck"),
	BanishSource UMETA(DisplayName = "62 - Generic: Banish Source"),
	DrawCardsForBothPlayers UMETA(DisplayName = "63 - Generic: Draw Cards For Both Players"),
	NegateActivation UMETA(DisplayName = "64 - Generic: Negate Activation"),
	SwapUnitZones UMETA(DisplayName = "65 - Generic: Swap Unit Zones"),
	CheckMaterialCount UMETA(DisplayName = "66 - Generic: Check Material Count"),
	DiscardRandomCards UMETA(DisplayName = "67 - Generic: Discard Random Cards"),
	PlayCardToEmptyZone UMETA(DisplayName = "68 - Generic: Play Card To Empty Zone"),
	PlayHandCardToEmptyZone UMETA(DisplayName = "69 - Generic: Play Hand Card To Empty Zone"),
	MoveDeckCardToHand UMETA(DisplayName = "70 - Generic: Move Deck Card To Hand"),
	PlayHandCardOnUnit UMETA(DisplayName = "71 - Generic: Play Hand Card On Unit"),
	PlayGraveyardCardOnUnit UMETA(DisplayName = "72 - Generic: Play Graveyard Card On Unit"),
	CannotBeDestroyedByCardEffects UMETA(DisplayName = "80 - Passive: Cannot Be Destroyed By Card Effects"),
