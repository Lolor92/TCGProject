...
public:
	...
	UPROPERTY(BlueprintReadOnly, Replicated, Category = "TCG|Choice") FTCGPendingPlayToEmptyZoneChoice PendingPlayToEmptyZoneChoice;
	UPROPERTY(BlueprintReadOnly, Replicated, Category = "TCG|Choice") FTCGPendingAttachSourceToWaterUnitChoice PendingAttachSourceToWaterUnitChoice;
...
public:
	...
	FTCGCardInstance& AddCardInstance(FName CardDefinitionId, ETCGCardElement Element, int32 BaseAttack, int32 OwnerPlayerIndex, ETCGCardLocation StartingLocation);
	FTCGCardInstance* AddCardInstanceFromDefinition(const UTCG_CardDefinition* CardDefinition, int32 OwnerPlayerIndex, ETCGCardLocation StartingLocation);
	FTCGCardInstance& AddDebugCardInstance(FName CardDefinitionId, ETCGCardElement FallbackElement, int32 FallbackBaseAttack, int32 OwnerPlayerIndex, ETCGCardLocation StartingLocation);
	...
	bool AddCardEffectRefToChain(TArray<FTCGEffectChainEntry>& Chain, const FGuid& SourceCardInstanceId, const FGuid& TargetCardInstanceId, const FTCGCardEffectRef& EffectRef);
	...
	UFUNCTION(BlueprintCallable, Category = "TCG|Choice") bool SubmitPendingDiscardChoice(int32 PlayerIndex, const TArray<FGuid>& ChosenCardInstanceIds);
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") bool HasPendingDiscardChoice() const;
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") void GetPendingDiscardChoiceOptions(TArray<FGuid>& OutCardInstanceIds) const;
	...
	UFUNCTION(BlueprintCallable, Category = "TCG|Choice") bool SubmitPendingGraveyardToDeckChoice(int32 PlayerIndex, const TArray<FGuid>& ChosenCardInstanceIds);
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") bool HasPendingGraveyardToDeckChoice() const;
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") void GetPendingGraveyardToDeckChoiceOptions(TArray<FGuid>& OutCardInstanceIds) const;
	...
	UFUNCTION(BlueprintCallable, Category = "TCG|Choice") bool SubmitPendingPlayToEmptyZoneChoice(int32 PlayerIndex, FName ChosenZoneId);
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") bool HasPendingPlayToEmptyZoneChoice() const;
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") void GetPendingPlayToEmptyZoneChoiceOptions(TArray<FName>& OutZoneIds) const;
	...
	UFUNCTION(BlueprintCallable, Category = "TCG|Choice") bool SubmitPendingAttachSourceToWaterUnitChoice(int32 PlayerIndex, const FGuid& ChosenTargetCardInstanceId);
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") bool HasPendingAttachSourceToWaterUnitChoice() const;
	UFUNCTION(BlueprintPure, Category = "TCG|Choice") void GetPendingAttachSourceToWaterUnitChoiceOptions(TArray<FGuid>& OutCardInstanceIds) const;
