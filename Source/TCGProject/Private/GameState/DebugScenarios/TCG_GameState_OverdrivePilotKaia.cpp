...
UTCG_CardDefinition* Kaia = MakeDebugDefinition(
GameState,
...
Kaia->Effects.Add(KaiaMachinePlayed);
...
GameState->DebugCardDefinitions.Add(Kaia);
GameState->DebugCardDefinitions.Add(Machine);

FTCGCardInstance* PlayedKaia = GameState->AddCardInstanceFromDefinition(Kaia, 0, ETCGCardLocation::Hand);
if (!PlayedKaia)
{
return;
}
...
FTCGCardInstance* HandKaia = GameState->AddCardInstanceFromDefinition(Kaia, 0, ETCGCardLocation::Hand);
if (!HandKaia)
{
return;
}
